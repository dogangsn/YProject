$(function () {
    ...
    var table = $("#dataTable").DataTable({
        ...
        "order": [[0, "desc"]],
        "ajax": {
            "url": '/admin/categories/categoryList',
            "type": "POST"
        },
        ...
        "columns": [
            ...
            { "data": "Name", "name": "Name", "autoWidth": true },
            {
                ...
                "render": function (data, row) {
                    var editButton = '<a href="/admin/categories/save/' + data.CategoryId + '" class="btn bg-slate btn-sm"><i class="fa fa-pen"></i> Düzenle</a>';
                    var deleteButton = '<button id=' + data.CategoryId + ' class="btn btn-danger btn-sm btnDelete"><i class="fa fa-trash"></i> Sil</button>';
...
function Delete(id) {
    $.ajax({
        type: "POST",
        url: "/admin/categories/categoryDelete/", 
        data: { id: id },
        beforeSend: function () {
            $.LoaderOpen({ selector: ".datatable" });
        },
